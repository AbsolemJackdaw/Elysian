...
public class WorldGenElysianTrees extends WorldGenAbstractTree{
	...
	public WorldGenElysianTrees(boolean par1)
	{
		this(par1, 4, new Random().nextInt(7), 0);
	}

	/**@param par2 : minimum tree hight
	 * @param par3 meta data for wood
	 * @param par4 metadata for leaves*/
	public WorldGenElysianTrees(boolean par1, int par2, int par3, int par4)
	{
		super(par1);
	...
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		...
		if (par4 >= 1 && par4 + l + 1 <= 256)
		{
			...
			else
			{
				...
				boolean isSoil = block2.equals(ElysianBlocks.grass);
				...
				if (isSoil && par4 < 256 - l - 1)
				{
						...
						for (i2 = par3 - l1; i2 <= par3 + l1; ++i2)
						{
							...
							for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2)
							{
								...
								if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0)
								{
									...
									{
										this.setBlockAndNotifyAdequately(par1World, i2, k1, k2, ElysianBlocks.leaves, this.metaLeaves);
					...
					for (k1 = 0; k1 < l; ++k1)
					{
						...
						{
							this.setBlockAndNotifyAdequately(par1World, par3, par4 + k1, par5, ElysianBlocks.log, this.metaWood);
						}
					}
					return true;
				}
