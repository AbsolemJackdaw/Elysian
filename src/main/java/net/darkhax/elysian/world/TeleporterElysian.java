...
public class TeleporterElysian extends Teleporter {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8) {
			...
			for (l3 = l - short1; l3 <= l + short1; ++l3) {
				...
				for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1) {
					...
					for (int i2 = this.worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2) {
						...
						if (this.worldServerInstance.getBlock(l3, i2, l1) == ElysianBlocks.portal) {
							while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == ElysianBlocks.portal) {
								--i2;
							}
		...
		if (d3 >= 0.0D) {
			...
			if (this.worldServerInstance.getBlock(i - 1, j, k) == ElysianBlocks.portal) {
				i4 = 2;
			}
			...
			if (this.worldServerInstance.getBlock(i, j, k - 1) == ElysianBlocks.portal) {
				i4 = 3;
			}
	...
	public boolean makePortal(Entity par1Entity) {
		...
		if (d0 < 0.0D) {
			...
			this.worldServerInstance.setBlock(k5, j2-3, k2,
					ElysianBlocks.stone);
		}
		this.worldServerInstance.setBlock(k5, j2, k2, ElysianBlocks.portal);
