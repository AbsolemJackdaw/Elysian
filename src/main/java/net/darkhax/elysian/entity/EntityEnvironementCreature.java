...
import net.darkhax.elysian.entity.effects.EntityElysianEnvironementEffect;
...
public class EntityEnvironementCreature extends EntityLiving implements	IAnimals {

	private ChunkCoordinates spawnPosition;

	public EntityEnvironementCreature(World par1World) {
		super(par1World);
		setSize(0.2f, 0.2f);
	}
