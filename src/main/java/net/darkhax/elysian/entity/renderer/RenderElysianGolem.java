...
public class RenderElysianGolem extends RenderLiving {
	...
	ResourceLocation glow= new ResourceLocation("elysian:/textures/mobs/rune_golem_glow.png");
	ResourceLocation golem= new ResourceLocation("elysian:/textures/mobs/rune_golem.png");
	...
	protected int sheepTexturing(EntityRuneGolem buddy, int par2, float par3)
	{
		...
		if(par2 == 0){
			...
			float time = (float)Math.cos(Elysian.getSysTimeF()/20f);
			float angry = (float)Math.cos(Elysian.getSysTimeF()/2f);
